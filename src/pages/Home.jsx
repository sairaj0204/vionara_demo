...
const Home = () => {
    ...
    return (
        <div className="bg-white">
            ...
            <section className="pt-10 pb-4 bg-white" id="categories-section">
                            ...
                            >
                                <Link href={`/collections/${cat.slug}`} className="category-card block group">
                                    <div className={`aspect-[4/5] bg-gray-200 relative overflow-hidden rounded-none animate-pulse`}>
                                        <Image
                                            src={getImageUrl(cat.thumbnail) || 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600'}
                                            alt={cat.name}
                                            fill
                                            sizes="(max-width: 768px) 33vw, 16vw"
                                            className="object-cover group-hover:scale-105 transition-transform duration-1000 absolute inset-0 text-transparent"
                                            onLoad={(e) => {
             ...
             */}
            <section className="pt-8 lg:pt-10 pb-16 lg:pb-24 bg-white" id="top-styles-section">
                ...
                <div className="w-full px-4 sm:px-6 lg:px-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0">
                        {giftCombos.map((combo, i) => (
                            ...
                            >
                                <Link href="/shop" className="block relative aspect-square overflow-hidden bg-gray-50">
                                        <Image
                                            src={combo.image}
                                            alt={combo.name}
                                            fill
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {reviews.map((review, i) => (
                            ...
                            >
                                ...
                                <p className="text-[15px] text-gray-600 leading-relaxed font-light italic mb-8 flex-grow">
                    ...
                    <div className="w-full px-1 sm:px-2">
                        ...
                        <div className="grid grid-cols-3 md:grid-cols-6 gap-2 sm:gap-4">
                            {instagramPosts.posts.slice(0, 6).map((post, i) => (
                                ...
                                >
                                    <Image 
                                        src={getImageUrl(post.imageUrl) || "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400"} 
                                        alt={`Instagram ${i + 1}`} 
                                        fill
                                        sizes="(max-width: 768px) 33vw, 16vw"

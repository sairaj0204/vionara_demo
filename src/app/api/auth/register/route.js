 ...
 * Reverted to OTP-based signup flow.
 * Validates details, then sends verification OTP before user creation.
 */
export async function POST(req) {
    ...
    try {
        ...
        const result = await requestAuthOtp({ ...payload, purpose: 'signup' });
